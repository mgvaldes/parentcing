...
public class PCMapStyle {
	...
	public static PCMapMarkersEnum getDeviceMapMapMarker(Integer smartphoneIndex){
		smartphoneIndex%=21;
		return deviceMapMarkersArray[smartphoneIndex];
	}
	...
	public static String getMarkerDeviceMapImageURL(Integer smartphoneIndex){
		PCMapMarkersEnum mapMarker = getDeviceMapMapMarker(smartphoneIndex);
		return markerDeviceMapImagesURL+"/"+mapMarker.getImageName();
	}
}
