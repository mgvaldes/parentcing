...
public class NewEmergencyContact extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    if (httpClientHandlerApp == null) { 
			httpClientHandlerApp = (HttpClientHandler) NewEmergencyContact.this.getApplication();
		}
	    ...
	    setContentView(R.layout.new_emergency_contact);
	...
	public void loadDailyRoute() {
		Intent i = new Intent(NewEmergencyContact.this, DailyRoute.class);
		httpClientHandlerApp.lastView = PCViewsEnum.NEW_RULE_VIEW.getId();
		startActivity(i);
	}

	public void loadAlertList() {
		Intent i = new Intent(NewEmergencyContact.this, AlertList.class);
		httpClientHandlerApp.lastView = PCViewsEnum.NEW_RULE_VIEW.getId();
		startActivity(i);
	}
	
	public void loadRuleList() {
		Intent i = new Intent(NewEmergencyContact.this, RuleList.class);
		httpClientHandlerApp.lastView = PCViewsEnum.NEW_RULE_VIEW.getId();
		startActivity(i);
	}
	
	public void loadContactList() {
		Intent i = new Intent(NewEmergencyContact.this, ContactList.class);
		httpClientHandlerApp.lastView = PCViewsEnum.NEW_RULE_VIEW.getId();
		startActivity(i);
	}
	
	public void loadSmartphoneSettings() {
		Intent i = new Intent(NewEmergencyContact.this, SmartphoneSettings.class);
		httpClientHandlerApp.lastView = PCViewsEnum.NEW_RULE_VIEW.getId();
		startActivity(i);
	}
	...
	public void loadDeviceMap() {
		if (httpClientHandlerApp.pendingChanges) {
			...
			Intent i = new Intent(NewEmergencyContact.this, SmartphoneMap.class);			
			startActivity(i);
		}
	}
	...
	public void loadDeviceList() {
		if (httpClientHandlerApp.pendingChanges) {
			...
			Intent i = new Intent(NewEmergencyContact.this, SmartphoneList.class);
			startActivity(i);
		}
	}
	...
	public void onSaveContactClick(View v) {
		if (checkEditTextFieldsFilled()) {
			...
			///////////////////////////////////////////////
			this.smartphone.getAddedEmergencyNumbers().add(newEmergencyNumber);
			
			Intent i = new Intent(NewEmergencyContact.this, EmergencyContactList.class);
	...
	protected Dialog onCreateDialog(int id) {
		if (id == ALERT_DIALOG) {
			AlertDialog.Builder alert = new AlertDialog.Builder(NewEmergencyContact.this);
	...
	private void showProcessDialog() {
		processDialog = ProgressDialog.show(NewEmergencyContact.this, null, NewEmergencyContact.this.getString(R.string.progress_dialog_save_changes), true, true,
			new OnCancelListener() {
				@Override
				public void onCancel(DialogInterface dialog) {
					if (asyncSaveChangesThread.cancel(true)) {
						UiUtils.levantarDialog(NewEmergencyContact.this, UiUtils.DIALOG_OK, getString(R.string.progress_dialog_save_changes_cancel));
					} 
					else {
	...
	private void showTicketsListProcessDialog() {
		processDialog = ProgressDialog.show(NewEmergencyContact.this, null, NewEmergencyContact.this.getString(R.string.progress_dialog_tickets_list), true, true,
			new OnCancelListener() {
				@Override
				public void onCancel(DialogInterface dialog) {
					if (asyncTicketsListThread.cancel(true)) {
						UiUtils.levantarDialog(NewEmergencyContact.this, UiUtils.DIALOG_OK, getString(R.string.progress_dialog_tickets_list_cancel));
					} 
					else {
	...
	private void showAdminUserListProcessDialog() {
		processDialog = ProgressDialog.show(NewEmergencyContact.this, null, NewEmergencyContact.this.getString(R.string.progress_dialog_admin_user_list), true, true,
			new OnCancelListener() {
				@Override
				public void onCancel(DialogInterface dialog) {
					if (asyncAdminUserListThread.cancel(true)) {
						UiUtils.levantarDialog(NewEmergencyContact.this, UiUtils.DIALOG_OK, getString(R.string.progress_dialog_admin_user_list_cancel));
					} 
					else {
			...
			try {
				...
				if (inputStream != null) {
					...
					if (code.equals("00")) {			
						...
						if (nextScreen == 0) {
							i = new Intent(NewEmergencyContact.this, SmartphoneMap.class);
						}
						else {
							i = new Intent(NewEmergencyContact.this, SmartphoneList.class);
						}
						
						httpClientHandlerApp.pendingChanges = false;
						httpClientHandlerApp.lastView = PCViewsEnum.NEW_EMERGENCY_CONTACT_VIEW.getId();
			...
			try {
				...
				if (inputStream != null) {
					...
					if (code.equals("00")) {
						...
						Intent i = new Intent(NewEmergencyContact.this, TicketList.class);
			...
			try {
				...
				if (inputStream != null) {
					...
					if (code.equals("00")) {
						...
						Intent i = new Intent(NewEmergencyContact.this, AdminUserList.class);
						httpClientHandlerApp.lastView = PCViewsEnum.DAILY_ROUTE_VIEW.getId();
