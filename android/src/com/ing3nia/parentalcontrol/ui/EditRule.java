...
//                			UiUtils.levantarDialog(NewRule.this, UiUtils.DIALOG_OK, getString(R.string.end_time_warning_dialog_new_rule));
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    if (httpClientHandlerApp == null) { 
			httpClientHandlerApp = (HttpClientHandler) EditRule.this.getApplication();
		}
	    ...
	    editRule = getIntent().getBundleExtra("smartphonesInfo").getParcelable("rule");
	    disabledFuncsStatus = getIntent().getBundleExtra("smartphonesInfo").getBooleanArray("disabledFuncsStatus");
	    selectedRule = getIntent().getBundleExtra("smartphonesInfo").getInt("selectedRule");
		...
		try {
			startDateD = formatter3.parse(editRule.getStartDate());
			endDateD = formatter3.parse(editRule.getEndDate());
		} 
	    ...
	    editTextRuleName.setText(editRule.getName());
	    ...
	    editTextStartDate.setText(formatter4.format(startDateD));
	    ...
	    editTextStartTime.setText(formatter.format(startDateD));
	    ...
	    editTextEndDate.setText(formatter4.format(endDateD));
	    ...
	    editTextEndTime.setText(formatter.format(endDateD));
	    ...
	    ruleTypeSpinner.setSelection(editRule.getType());
	}
    ...
    public void onSelectDisabledFuncsClick(View v) {
    	Dialog d = createDisabledFuncsDialog();
		d.show();
	}
	...
	public void loadDailyRoute() {
		Intent i = new Intent(EditRule.this, DailyRoute.class);
		httpClientHandlerApp.lastView = PCViewsEnum.EDIT_RULE_VIEW.getId();
		startActivity(i);
	}

	public void loadAlertList() {
		Intent i = new Intent(EditRule.this, AlertList.class);
		httpClientHandlerApp.lastView = PCViewsEnum.EDIT_RULE_VIEW.getId();
		startActivity(i);
	}
	
	public void loadRuleList() {
		Intent i = new Intent(EditRule.this, RuleList.class);
		httpClientHandlerApp.lastView = PCViewsEnum.EDIT_RULE_VIEW.getId();
		startActivity(i);
	}
	
	public void loadContactList() {
		Intent i = new Intent(EditRule.this, ContactList.class);
		httpClientHandlerApp.lastView = PCViewsEnum.EDIT_RULE_VIEW.getId();
		startActivity(i);
	}
	
	public void loadSmartphoneSettings() {
		Intent i = new Intent(EditRule.this, SmartphoneSettings.class);
		httpClientHandlerApp.lastView = PCViewsEnum.EDIT_RULE_VIEW.getId();
		startActivity(i);
	}
	...
	public void loadDeviceMap() {
		if (httpClientHandlerApp.pendingChanges) {
			...
			Intent i = new Intent(EditRule.this, SmartphoneMap.class);
			startActivity(i);
		}
	}
	...
	public void loadDeviceList() {
		if (httpClientHandlerApp.pendingChanges) {
			...
			Intent i = new Intent(EditRule.this, SmartphoneList.class);
			startActivity(i);
		}
	}
	...
	public void saveChangesInSmartphone(RuleModel rule) {
		RuleModel changed;
		
		changed = this.smartphone.getRules().get(selectedRule);
		changed.setCreationDate(rule.getCreationDate());
		changed.setDisabledFunctionalities(rule.getDisabledFunctionalities());
		changed.setEndDate(rule.getEndDate());
		changed.setName(rule.getName());
		changed.setStartDate(rule.getStartDate());
		changed.setType(rule.getType());
	}
	...
	public void onSaveRuleClick(View v) {
		if (checkEditTextFieldsFilled()) {
			...
			newRule.setKeyId(editRule.getKeyId());
			rules.add(newRule);
			
			/////////////////////////////////
			// Cambiar regla en smartphone
			/////////////////////////////////
			saveChangesInSmartphone(newRule);
	...
	public Dialog createDisabledFuncsDialog() {
		AlertDialog.Builder dialog = new AlertDialog.Builder(EditRule.this);
		...
		dialog.setPositiveButton(R.string.cancel_button_label, new DialogInterface.OnClickListener() {
	...
	protected Dialog onCreateDialog(int id) {
		...
		if (id == DATE_DIALOG_ID) {
			...
			AlertDialog.Builder alert = new AlertDialog.Builder(EditRule.this);
	...
	private void showProcessDialog() {
		processDialog = ProgressDialog.show(EditRule.this, null, EditRule.this.getString(R.string.progress_dialog_save_changes), true, true,
			new OnCancelListener() {
				@Override
				public void onCancel(DialogInterface dialog) {
					if (asyncSaveChangesThread.cancel(true)) {
						UiUtils.levantarDialog(EditRule.this, UiUtils.DIALOG_OK, getString(R.string.progress_dialog_save_changes_cancel));
					} 
					else {
	...
	private void showTicketsListProcessDialog() {
		processDialog = ProgressDialog.show(EditRule.this, null, EditRule.this.getString(R.string.progress_dialog_tickets_list), true, true,
			new OnCancelListener() {
				@Override
				public void onCancel(DialogInterface dialog) {
					if (asyncTicketsListThread.cancel(true)) {
						UiUtils.levantarDialog(EditRule.this, UiUtils.DIALOG_OK, getString(R.string.progress_dialog_tickets_list_cancel));
					} 
					else {
	...
	private void showAdminUserListProcessDialog() {
		processDialog = ProgressDialog.show(EditRule.this, null, EditRule.this.getString(R.string.progress_dialog_admin_user_list), true, true,
			new OnCancelListener() {
				@Override
				public void onCancel(DialogInterface dialog) {
					if (asyncAdminUserListThread.cancel(true)) {
						UiUtils.levantarDialog(EditRule.this, UiUtils.DIALOG_OK, getString(R.string.progress_dialog_admin_user_list_cancel));
					} 
					else {
			...
			try {
				...
				if (inputStream != null) {
					...
					if (code.equals("00")) {			
						...
						if (nextScreen == 0) {
							i = new Intent(EditRule.this, SmartphoneMap.class);
						}
						else {
							i = new Intent(EditRule.this, SmartphoneList.class);
						}
			...
			try {
				...
				if (inputStream != null) {
					...
					if (code.equals("00")) {
						...
						Intent i = new Intent(EditRule.this, TicketList.class);
			...
			try {
				...
				if (inputStream != null) {
					...
					if (code.equals("00")) {
						...
						Intent i = new Intent(EditRule.this, AdminUserList.class);
						httpClientHandlerApp.lastView = PCViewsEnum.DAILY_ROUTE_VIEW.getId();
